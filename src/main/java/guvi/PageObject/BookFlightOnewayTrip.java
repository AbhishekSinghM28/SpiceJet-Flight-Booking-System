...
public class BookFlightOnewayTrip
{
	public WebDriver driver;
	
	public BookFlightOnewayTrip(WebDriver driver) 
	{
		this.driver=driver;
	...
	@FindBy(xpath="//div[@class='css-76zvg2 r-homxoj r-poiln3 r-1b43r93 r-zso239']")
	WebElement flightno;
	
	@FindBy(xpath="//div[@class='css-76zvg2 r-homxoj r-poiln3 r-1b43r93']")
	WebElement date;
	
	@FindBy(xpath="//div[@class='css-76zvg2 r-homxoj r-poiln3 r-1b43r93 r-1f6r7vd']")
	WebElement time;
	...
	{
		System.out.println("Verifying the Booking Details");
		System.out.println("---------------------------------");		
		System.out.println("Source to Destination : "+""+source.getText()+" to "+destination.getText());
		System.out.println("Flight Number : "+""+flightno.getText());
		System.out.println("Date - Time : "+""+date.getText()+" - "+time.getText());		
		System.out.println("Payable Amount(Incl. of taxes) : "+""+payableamount.getText()+" INR");
		
		String expectedProductName="Mon, 01 May 2023";
		Assert.assertEquals(date.getText(),expectedProductName);	
