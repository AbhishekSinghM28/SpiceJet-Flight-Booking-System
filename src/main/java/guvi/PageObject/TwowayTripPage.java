...
public class TwowayTripPage 
{
	public WebDriver driver;
	public TwowayTripPage(WebDriver driver)
	{
		this.driver=driver;
	...
	//Code to book a TwoWayTrip flight.
	@FindBy(xpath="//div[contains(text(),'round trip')]")
	WebElement twotripbutton;
	...
	@FindBy(xpath="(//div[@data-testid='undefined-month-May-2023'])/div[3]/div[2]/div[3]/div[1]")
	...
	//Creating methods	
	public void twoWayTripDetails(String Boarding, String Destination)
	{
		twotripbutton.click();
