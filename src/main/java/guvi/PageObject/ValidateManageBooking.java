...
public class ValidateManageBooking 
{
	public WebDriver driver;

	public ValidateManageBooking(WebDriver driver) 
	{
		this.driver=driver;
		PageFactory.initElements(driver,this);
	}
	
	//Code to Validate Manage Booking Module.
	...
	WebElement pnrnumbererror;
		...
		public void manageBooking(String pnrnumber, String email)
		{
			buttonCheckIn.click();		
			feildPNR.click();
